...
import { addUser, editUserA } from './../action/userAction';
import "./addData.css"
    ...
    formSubmit = () => {
        ...
        if (this.state.isMobile && this.state.isEmail && this.state.src) {
            ...
            if (this.props.isEdit) {
                localValue.index = this.props.AValue.index;
                this.props.editUserA(localValue)
            }
            else this.props.addUser(localValue)
...
export default connect(mapStateToProps, { addUser,editUserA })(withRouter(AddData))
